...
public:
   ...
   void update( float delta )
   {
      ...
      if ( mMode == WALK )
      {
         gmtl::EulerAngleXYZf euler( 0.0, gmtl::makeYRot(delta_rot), 0.0 );// Only allow Yaw (rot y)
...
private:
   ...
   cluster::UserData< NavData >  mNavData; // Current postion (as UserData for sharing across cluster)
